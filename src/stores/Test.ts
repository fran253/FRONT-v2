...
export const useTestStore = defineStore("test", () => {
  ...
  async function fetchAllTests() {
    try {
      const response = await fetch("https://academiqapi.retocsv.es/api/Test");
  ...
  async function fetchTestById(idTest: number) {
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/Test/${idTest}`);
  ...
  async function fetchTestsByTemario(idTemario: number) {
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/Test/temario/${idTemario}`);

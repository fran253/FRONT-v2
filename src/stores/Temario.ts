...
export const useTemarioStore = defineStore("temario", () => {
  ...
  async function fetchAllTemarios() {
    try {
      const response = await fetch("https://academiqapi.retocsv.es/api/Temario");
  ...
  async function fetchTemarioById(idTemario: number) {
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/Temario/${idTemario}`);
  ...
  async function fetchTemariosByAsignatura(idAsignatura: number) {
    try {
      const response = await fetch(`https://academiqapi.retocsv.es/api/Temario/asignatura/${idAsignatura}`);
